...
no_margin = dict(l=10, r=10, t=10, b=10)
...
# --------------------------------------------------------
    ...
    if country_dropdown:
        ...
        top10_plot = go.Figure(go.Bar(
            ...
            '%{customdata[1]:.3s} morts <extra></extra>',
            marker_color=marker_color))
    top10_plot.update_layout(hovermode="y unified", showlegend=False, margin= no_margin)
...
# --------------------------------------------------------
    ...
    total_case.update_layout(hovermode="x unified", margin=no_margin, showlegend=False)
...
# --------------------------------------------------------
    ...
    new_cases_plot.update_layout(hovermode="x unified", showlegend=False, margin=no_margin)
